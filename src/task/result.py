...
def get_result_filename(task_id: int) -> str:
    return os.path.join(RESULT_DIR, f"{task_id}_data.jsonl")
...
async def get_product_history_info(task_id: int, ) -> TaskResultHistory:
    filename = get_result_filename(task_id)
